...
* **Временная рентабельность обработки прерывания**: обработчик должен завершаться быстрее, чем период аппаратного прерывания (~55 мс для таймерного тика). В противном случае возможны взаимные перекрытия вызовов, зацикливание и зависания системы.
